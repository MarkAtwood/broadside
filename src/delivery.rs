...
// Upgrade path: persist trip counts if multi-process deployment is needed.
#[derive(Default)]
...
pub async fn fan_out(pool: &Pool, post_id: &str, persona_id: i64) -> anyhow::Result<u64> {
...
pub async fn run_worker(pool: Pool, domain: String) {
